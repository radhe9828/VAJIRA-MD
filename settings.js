...
global.owner = process.env.OWNER_NUMBER  || '923113044693' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=fIskxITD#ZQCOsvDAlw0UwdBlZzN3FALDtPcgMDbXIxXmfYY62a8' ,
